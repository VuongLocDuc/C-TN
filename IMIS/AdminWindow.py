...
class AdminWindow(QMainWindow):
    ...
    def __init__(self, maNV, tenNV, boPhan):
        ...
        content = "IMIS - Inventory Management Information System là hệ thống quản lý hàng tồn kho giúp cân đối và tối ưu hàng tồn kho. Hệ thống được xây dựng bởi FPT Telecom"
        ...
        self.ui.model.clicked.connect(lambda: AppFunction.BuildModel(self))
